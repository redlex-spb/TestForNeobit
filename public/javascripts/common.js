function app() {
	...
	function checkTor() {
		makeRequest("GET","/check_is_tor",true,false,false,"json",function (status,response) {
			//isTor = response.isTor;
			//completeData.forPrint.proxy.tor = response.isTor;
			completeData.tor = {};
			completeData.tor.is_tor = isTor;
		});
	}
	...
	function onComplete() {
		fetch('/get_complete_data?webrtc_ip='+completeData.webrtc.ip)
